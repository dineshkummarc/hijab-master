			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table datatable table-bordered">
						...
						<tbody>
							<?php $no=1; foreach ($stock_list as $d_row) { ?>
							<tr>
								...
								<td class="text-center"><!-- <input type="number" value="<?php echo $d_row->stock; ?>" name="stock[]" id="stock-<?php echo $d_row->id?>"><br><input type="hidden" value="<?php echo $d_row->id; ?>" name="id[]" id="id-<?php echo $d_row->id?>"> --><?php echo $d_row->stock?></td>
							</tr>
							<?php $no++; } ?>
						</tbody>
					</table>
