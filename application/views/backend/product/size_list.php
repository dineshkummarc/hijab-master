			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table datatable table-bordered">
						...
						<tbody>
							<?php $no=1; foreach ($size_list as $d_row) { ?>
							<tr>
...
<!-- MESSAGE BOX -->
<div id="px-size-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/'.$function_delete; ?>" method="post" id="px-size-message-form">
...
<!-- START SCRIPTS -->               
	...
	<script type="text/javascript" src="assets/backend_assets/page/product/size_list.js"></script>