    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" action="<?php if ($data) echo $controller . '/' . $function_edit; else echo $controller . '/' . $function_add; ?>" method="POST" id="px-brand-form">
                    <input type="hidden" name="id" id="px-brand-form-id" value="<?php if ($data) echo $data->id; ?>">
                    <div class="panel-body">
                        <div class="alert alert-success hidden"><strong>Success! </strong><span></span></div>
                        <div class="alert alert-warning hidden"><strong>Processing! </strong><span>Please wait...</span></div>
                        <div class="alert alert-danger hidden"><strong>Failed! </strong><span></span></div>
                        <div class="form-group">
                            <label class="col-md-2 col-xs-12 control-label" for="#px-brand-form-title">Nama Brand</label>
                            <div class="col-md-9 col-xs-12">
                                <input type="text" class="form-control" name="name" id="px-brand-form-title" value="<?php if ($data) echo $data->name; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-xs-12">
                                ...
                                <label for="file-upload-file" class="btn btn-primary btn-upload" data-target="photo" id="px-brand-fileupload-photo-upload-button">Browse</label>
                            </div>
                            <?php
                            if ($data) {
                                if (is_file('assets/uploads/brand/' . $data->id . '/' . $data->photo)) {
                                    $photo = ' ';
                                    $photo_file = 'assets/uploads/brand/' . $data->id . '/' . $data->photo;
                                } else {
                                    $photo = 'hidden';
                                    $photo_file = ' ';
                                }
...
<script type="text/javascript" src="assets/backend_assets/page/product/brand_form.js"></script>
<!--  -->
<!-- END SCRIPTS -->   