                        ...
                        <tbody>
                            ...
                            foreach ($product_list as $d_row) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><button id="show_flag<?php echo $d_row->id ?>" class="btn btn-change-status <?php if ($d_row->show_flag == 0) echo 'btn-danger';
                                else echo 'btn-success' ?>" row_id="<?php echo $d_row->id ?>"><?php if ($d_row->show_flag == 0) echo "Hide";
                                else echo "Show" ?></button></td>
