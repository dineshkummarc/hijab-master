			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table datatable table-bordered">
						...
						<tbody>
							<?php $no=1; foreach ($product_list as $d_row) { ?>
							<tr>
								<td class="text-center"><?php echo $no; ?></td>
								<td class="text-center"><?php echo $d_row->name_product; ?></td>
								<td class="text-center"><button id="delete_flag<?php echo $d_row->id ?>" class="btn btn-change-status <?php if($d_row->delete_flag == 0) echo 'btn-danger'; else echo 'btn-success' ?>" row_id="<?php echo $d_row->id ?>"><?php if($d_row->delete_flag == 0) echo "Hide"; else echo "Show" ?></button></td>
...
<!-- MESSAGE BOX -->
<div id="px-product-product_list-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/'.$function_delete; ?>" method="post" id="px-product-product_list-message-form">
