    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" action="<?php if ($data) echo $controller . '/' . $function_edit; else echo $controller . '/' . $function_add; ?>" method="POST" id="px-color-form">
                    <input type="hidden" name="id" id="px-color-form-id" value="<?php if ($data) echo $data->id; ?>">
...
<script type="text/javascript" src="assets/backend_assets/page/product/color_form.js"></script>
<!--  -->
<!-- END SCRIPTS -->   