			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table datatable table-bordered">
						...
						<tbody>
							<?php $no=1; foreach ($brand_list as $d_row) { ?>
							<tr>
								<td class="text-center"><?php echo $no; ?></td>
								<td class="text-center"><?php echo $d_row->name; ?></td>
								<td class="text-center"><button id="promo_status<?php echo $d_row->id ?>" class="btn btn-change-status <?php if($d_row->promo_status == 0) echo 'btn-danger'; else echo 'btn-success' ?>" row_id="<?php echo $d_row->id ?>"><?php if($d_row->promo_status == 0) echo "No"; else echo "Yes" ?></button></td>
...
<!-- MESSAGE BOX -->
<div id="px-brand-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/'.$function_delete; ?>" method="post" id="px-brand-message-form">
...
<!-- START SCRIPTS -->               
	...
	<script type="text/javascript" src="assets/backend_assets/page/product/brand_list.js"></script>
