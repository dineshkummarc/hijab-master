			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table datatable table-bordered">
						...
						<tbody>
							<?php $no=1; foreach ($category_list as $d_row) { ?>
							<tr>
								...
								<td class="text-center">
									<form action="<?php echo $controller.'/'.$function_form; ?>" method="post">
										...
										<a href="<?=base_url('admin_product/category_image/'.$d_row->id)?>"><button  class="btn btn-info btn-xs btn-img" type="button" data-original-title="Image" data-placement="top" data-toggle="tooltip"><i class="fa fa-image"></i></button></a>
...
<!-- MESSAGE BOX -->
<div id="px-category-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/'.$function_delete; ?>" method="post" id="px-category-message-form">
...
<!-- START SCRIPTS -->               
	...
	<script type="text/javascript" src="assets/backend_assets/page/product/category_list.js"></script>