...
<div class="modal fade" id="upload-potrait" tabindex="-1" role="dialog" aria-labelledby="pixel-modal-warehouse-productimage-label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="pixel-modal-warehouse-productimage-label">Category Image Potrait</h4>
            </div>
            <form id="pixel-warehouse-productimage-form" class="form-horizontal" action="<?php echo $controller.'/upload_potrait/'.$id; ?>" method="POST">
						...
						<div class="box box-solid bg-light-blue">
							<div class="box-body text-center category-image-thumbnail potrait">
								...
								<div class="btn-group btn-group-xs">
									<button class="btn btn-primary btn-edit" data-target-edit="<?php echo $controller.'/category_image_edit/potrait/'.$id; ?>" data-target-get-data="<?php echo $controller.'/'.$function_get; ?>" data-target-id="<?php echo $id; ?>"><i class="fa fa-edit"></i></button>
			...
			<div class="col-md-6">
				...
				<div class="box">
					...
					<div class="col-md-12">
						<!-- Primary tile -->
						<div class="box box-solid bg-light-blue">
							<div class="box-body text-center category-image-thumbnail">
								<?php if($landscape!=''){ ?>
								<div class="btn-group btn-group-xs">
									<button class="btn btn-primary btn-edit" data-target-edit="<?php echo $controller.'/category_image_edit/landscape/'.$id;; ?>" data-target-get-data="<?php echo $controller.'/'.$function_get; ?>" data-target-id="<?php echo $id; ?>"><i class="fa fa-edit"></i></button>
									<!-- <a href="<?php echo $controller.'/'.$function_delete.'/'.$id; ?>" class="btn btn-danger"><i class="fa fa-times"></i></a> -->
								</div>
					...
					<?php if($landscape==''){ ?>
					<div class="col-md-12 text-center">
						<button class="btn btn-success btn-pop text-center" data-target-add="<?php echo $controller.'/category_image_add/landscape/'.$id; ?>" data-toggle="modal" data-target="#upload-potrait"><i class="fa fa-plus"></i> Add New</button>
					</div>
					<?php } ?>
					</div>
					</div><!-- /.box-body -->
