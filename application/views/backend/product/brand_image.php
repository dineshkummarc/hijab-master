<div class="modal fade" id="pixel-modal-warehouse-productimage" tabindex="-1" role="dialog" aria-labelledby="pixel-modal-warehouse-productimage-label" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form id="pixel-warehouse-productimage-form" class="form-horizontal" action="<?php echo $controller.'/brand_image_add'; ?>" method="POST">
			<input type="hidden" name="id" id="warehouse-productimage-id">
			<input type="hidden" name="brandimage-id" id="warehouse-productimage-product-id" value="<?php echo $id; ?>">
			<div class="modal-body">
				...
				<!-- <div class="form-group">
					...
					<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
						<input class="form-control" type="text" name="brandimage-caption" id="warehouse-productimage-caption">
					</div>
				</div> -->
				<div class="form-group">
					...
					<div class="col-md-3">
						...
						<div class="box box-solid bg-light-blue">
							<div class="box-body text-center product-image-thumbnail">
								...
								<?php if($image!=''){ ?>
								<img src="assets/uploads/brand/<?php echo $id.'/'.$image; ?>">
...
<script type="text/javascript" src="assets/backend_assets/page/product/brand_image.js"></script>
<!--  -->
<!-- END SCRIPTS -->   
