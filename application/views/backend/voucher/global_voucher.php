        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data voucher</h3>
                ...
                <div class="panel-body">
                    <table class="table datatable table-bordered">
                        ...
                        <tbody>
                        <?php $no=1; foreach ($voucher_list as $d_row) { ?>
                            <tr>
                                <td class="text-center"><?php echo $no; ?></td>
                                <td class="text-center"><?php echo $d_row->voucher; ?></td>
                                <td class="text-center"><button id="promo_status<?php echo $d_row->id ?>" class="btn btn-change-status <?php if($d_row->status == 0) echo 'btn-danger'; else echo 'btn-success' ?>" row_id="<?php echo $d_row->id ?>"><?php if($d_row->status == 0) echo "No"; else echo "Yes" ?></button></td>
...
<!-- MESSAGE BOX -->
<div id="px-voucher-message-box" class="message-box message-box-warning animated fadeIn fade">
    <div class="mb-container">
        <div class="mb-middle">
            <form action="<?php echo $controller.'/'.$function_delete; ?>" method="post" id="px-voucher-message-form">
...
<script type="text/javascript" src="assets/backend_assets/page/voucher/voucher.js"></script>