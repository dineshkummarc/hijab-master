		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">                                
					<h3 class="panel-title">Data Jasa Pengiriman</h3>
				...
				<div class="panel-body">
					<table class="table datatable table-bordered">
						...
						<tbody>
							<?php $no=1; foreach ($tracking_list as $d_row) { ?>
							<tr>
								<td class="text-center"><?php echo $no; ?></td>
								<td class="text-center"><?php echo $d_row->customer->nama_depan; ?> <?php echo $d_row->customer->nama_belakang; ?></td>
								<td class="text-center"><?php echo $d_row->flag_id; ?></td>
								<td class="text-center"><?php echo $d_row->shipping_flag_id; ?></td>
								<!-- <td class="text-center"><?php echo $d_row->jasa->name; ?></td> -->
...
<!-- MESSAGE BOX -->
<div id="px-tracking-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/'.$function_delete; ?>" method="post" id="px-tracking-message-form">
