    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" action="<?php if ($data) echo $controller . '/order_barang_edit'; else echo $controller . '/order_barang_add'; ?>" method="POST" id="px-category-form">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 col-xs-12 control-label" for="#px-order-form-name">Nama Barang</label>
                            <div class="col-md-9 col-xs-12">
                                <select name="product_id" class="form-control">
                                    <option value="">Pilih Barang</option>
                                    <?php foreach ($product as $produk) { ?>
                                    <option value="<?php echo $produk->id?>"<?php if($data) if($data->product_id == $d_row->id) echo 'selected' ?>><?php echo $produk->name_product?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 col-xs-12 control-label" for="#px-order-form-price">Harga</label>
                            <div class="col-md-9 col-xs-12">
                                <input type="number" class="form-control" name="price" id="px-order-form-price" value="<?php if ($data) echo $data->price; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 col-xs-12 control-label" for="#px-order-form-quantity">Quantity</label>
                            <div class="col-md-9 col-xs-12">
                                <input type="number" class="form-control" name="total_order" id="px-order-form-quantity" value="<?php if ($data) echo $data->quantity; ?>">
                            </div>
                        </div>
                    </div>
